...
Coofis Accessibility Widget: A React-based web accessibility widget to enhance UI/UX for all users.

```
yarn add github:givenjeremia/coofis-accessibility
```
Or
```
npm install github:givenjeremia/coofis-accessibility
```
Or
```
pnpm add github:givenjeremia/coofis-accessibility
```
...
yarn add github:givenjeremia/coofis-accessibility
npm install github:givenjeremia/coofis-accessibility
pnpm install github:givenjeremia/coofis-accessibility
```
